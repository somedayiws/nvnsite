...
<!-- form tìm kiếm -->
	...
	<% 
		...
		ArrayList<BAIVIET> list = (ArrayList<BAIVIET>)request.getAttribute("dsbaidang");
	...
	<div class="col-sm-8 col-md-8" id="baiviet" style="font-size: 12px;">
		...
		<div class="row">
				<p class="chao"><%= (String)request.getAttribute("meg") %></p>
		</div>
		...
		<div class="col-sm-6 col-md-6">
			...
			<label>Nhập mã xác nhận bên dưới</label>
			<%
			...
			%>
			<button type="submit" class="btn btn-primary row" id="btnSubmit">Cập nhật thông tin cá nhân</button>
		</div>
		</form>
		...
		<table class="table table-hover">
		  <tr id="tieude1">
		  	...
		  	<td class="clmta">Ngày đăng - 概要</td>
		  ...
		  %>
			  <tr class="noidung">
				...
				<td><%= list.get(i).getLuotXem() %></td>
			  	<td class="ctv-chon">
			  		<% if(list.get(i).getTrangThai().equals("Đã đăng")) { %>
			  			<a href="BaiVietServlet?id=<%= list.get(i).getIdBaiViet() %>"><i class="fa fa-eye-slash"> Xem</i></a>
			  		<% } else { %>
