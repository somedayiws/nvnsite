		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="DanhSachBaiDichServlet?view=all"><span class="glyphicon glyphicon-user"></span>QL thành viên<br>翻訳文書のリスト <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="ListAccountServlet"><span class="glyphicon glyphicon-user"></span>QL người dùng</a></li>
						<li><a href="CTVServlet"><span class="glyphicon glyphicon-signal"></span>QL cộng tác viên - 統計的</a></li>
					</ul>
				</li>
				...
				<li><a href="ThongBaoServlet"><span class="glyphicon glyphicon-bullhorn"></span>QL thông báo</a></li>
				<li><a href="AdvertisementServlet"><span class="glyphicon glyphicon-globe"></span>QL quảng cáo</a></li>
				<li><a href="TaiNguyenServlet"><span class="glyphicon glyphicon-briefcase"></span>QL tài nguyên</a></li>					
