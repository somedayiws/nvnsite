...
public class BaiVietDAO {
	...
	public BAIVIET getBaiViet(String id) {
		...
		try {
			if (rs.next()) {
				...
				bv.setTenBaiVietVi(DinhDangSQL.DeFomatSQL(rs
						.getString("TenBaiVietVi")));
				bv.setTenBaiVietJa(DinhDangSQL.DeFomatSQL(rs
				...
				bv.setDanhMuc(new DANHMUC(DinhDangSQL.DeFomatSQL(rs
						.getString("IdDanhMuc")), DinhDangSQL.DeFomatSQL(rs
						.getString("TenDanhMucVi")), DinhDangSQL.DeFomatSQL(rs
						.getString("TenDanhMucJa")), rs.getInt("HienThi")));
				bv.setTaiKhoan(new TAIKHOAN(DinhDangSQL.DeFomatSQL(rs
				...
				bv.setNoiDungVi(DinhDangSQL.DeFomatSQL(rs
						.getString("NoiDungVi")));
				bv.setNoiDungJa(DinhDangSQL.DeFomatSQL(rs
						.getString("NoiDungJa")));
				bv.setTrangThai(DinhDangSQL.DeFomatSQL(rs
						.getString("TrangThai")));
				...
				if (bv.getTrangThai().equals("OK"))
					db.updateData("update baiviet set LuotXem = LuotXem + 1 where IdBaiViet=N'"
							+ id + "'");
	...
	/*
	 * Lấy danh sách top bài viết từ vị trí nào đó trở đi return
	 * ArrayList<BAIVIET>/null
	 */
	public ArrayList<BAIVIET> getDanhSachBaiViet(int n, String top) {
		...
		try {
			while (rs.next()) {
				...
				BAIVIET bv = new BAIVIET(id, DinhDangSQL.DeFomatSQL(rs
						.getString("TenBaiVietVi")), DinhDangSQL.DeFomatSQL(rs
						.getString("TenBaiVietJa")), new DANHMUC(
						DinhDangSQL.DeFomatSQL(rs.getString("IdDanhMuc")),
						DinhDangSQL.DeFomatSQL(rs.getString("TenDanhMucVi")),
						DinhDangSQL.DeFomatSQL(rs.getString("TenDanhMucJa")),
						rs.getInt("HienThi")), new TAIKHOAN(
						DinhDangSQL.DeFomatSQL(rs.getString("IdTaiKhoan")),
						DinhDangSQL.DeFomatSQL(rs.getString("TenTaiKhoan")),
						DinhDangSQL.DeFomatSQL(rs.getString("MatKhau")),
						DinhDangSQL.DeFomatSQL(rs.getString("HoTen")),
						DinhDangSQL.DeFomatSQL(rs.getString("DiaChi")),
						rs.getString("DienThoai"), DinhDangSQL.DeFomatSQL(rs
								.getString("Email")), DinhDangSQL.DeFomatSQL(rs
								.getString("QuyenQuanTri"))),
						DinhDangSQL.DeFomatSQL(rs.getString("NoiDungVi")),
						DinhDangSQL.DeFomatSQL(rs.getString("NoiDungJa")),
						DinhDangSQL.DeFomatSQL(rs.getString("TrangThai")),
						DinhDangSQL.DeFomatSQL(rs.getString("GhiChu")));
	...
	/*
	 * Lấy danh sách top bài viết từ vị trí nào đó trở đi tương ứng của danh mục
	 * id return ArrayList<BAIVIET>/null
	 */
	public ArrayList<BAIVIET> getListBaiViet(String id, String vitri, String top) {
		// TODO Auto-generated method stub
		String sql = "select IdBaiViet,TenBaiVietVi,TenBaiVietJa,MoTaVi,MoTaJa,NoiDungVi,NoiDungJa,NgayDang,Lienket,LuotXem,HoTen from baiviet inner join taikhoan on baiviet.IdTaiKhoan=taikhoan.IdTaiKhoan where TrangThai=N'OK' and IdDanhMuc=N'"
				+ DinhDangSQL.FomatSQL(id)
				+ "' order by NgayDang desc, LuotXem desc limit "
				+ vitri
				+ ", " + top;
		...
		try {
			while (rs.next()) {
				...
				bv.setIdBaiViet(DinhDangSQL.DeFomatSQL(rs
						.getString("IdBaiViet")));
				bv.setTenBaiVietVi(DinhDangSQL.DeFomatSQL(rs
						.getString("TenBaiVietVi")));
				bv.setTenBaiVietJa(DinhDangSQL.DeFomatSQL(rs
	...
	/*
	 * Thêm bài viết song ngữ mới return true/false
	 */
	public boolean ThemBaiViet(String tieuDeVi, String moTaVi,
		...
		String sql = "insert into baiviet(IdBaiViet, TenBaiVietVi, TenBaiVietJa, IdDanhMuc, MotaVi, MotaJa, IdTaiKhoan, NoiDungVi, NoiDungJa, TrangThai, LuotXem, NgayDang, CoXoa, LienKet) values "
				...
				+ getID()
				+ "', N'"
				+ DinhDangSQL.FomatSQL(tieuDeVi)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(tieuDeJa)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(theLoai)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(moTaVi)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(moTaJa)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(taiKhoan)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(noiDungVi)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(noiDungJa)
				+ "', N'"
				+ trangThai
				+ "', '0', '"
	...
	/*
	 * Thêm bài viết bằng tiếng việt return true/false
	 */
	public boolean ThemBaiVietVi(String tieuDe, String moTa, String noiDung,
		...
		String sql = "insert into baiviet(IdBaiViet, TenBaiVietVi, IdDanhMuc, MotaVi, IdTaiKhoan, NoiDungVi, TrangThai, LuotXem, NgayDang, CoXoa, LienKet) values "
				...
				+ getID()
				+ "', N'"
				+ DinhDangSQL.FomatSQL(tieuDe)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(theLoai)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(moTa)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(taiKhoan)
				+ "', N'"
				+ DinhDangSQL.FomatSQL(noiDung)
				+ "', N'"
				+ trangThai
				+ "', '0', '"
				+ sdf.format(cal.getTime())
	...
	/*
	 * Thêm bài viết bằng tiếng nhật return true/false
	 */
	...
	/*
	 * Lấy Mã bài viết tiếp theo trong Data return String
	 */
	public String getID() {
		String Id = "BV00000000";
		ResultSet rs = db
				.getResultSet("select IdBaiViet from baiviet order by IdBaiViet desc limit 1");
		try {
			if (rs.next()) {
	...
	/*
	 * Dùng cho trang client Lấy danh sách 10 bài viết có lược view lớn nhất
	...
	public ArrayList<BAIVIET> getTopBaiViet(String loai) {
		...
		try {
			while (rs.next()) {
				...
				// BAIVIET bv = new BAIVIET(id,
				// DinhDangSQL.DeFomatSQL(rs.getString("TenBaiVietVi")),
				// DinhDangSQL.DeFomatSQL(rs.getString("TenBaiVietJa")), new
				// DANHMUC(DinhDangSQL.DeFomatSQL(rs.getString("IdDanhMuc")),
				// DinhDangSQL.DeFomatSQL(rs.getString("TenDanhMucVi")),
				// DinhDangSQL.DeFomatSQL(rs.getString("TenDanhMucJa")),
				// rs.getInt("HienThi")), new
				// TAIKHOAN(DinhDangSQL.DeFomatSQL(rs.getString("IdTaiKhoan")),
				// DinhDangSQL.DeFomatSQL(rs.getString("TenTaiKhoan")),
				// DinhDangSQL.DeFomatSQL(rs.getString("MatKhau")),
				// DinhDangSQL.DeFomatSQL(rs.getString("HoTen")),
				// DinhDangSQL.DeFomatSQL(rs.getString("DiaChi")),
				// DinhDangSQL.DeFomatSQL(rs.getString("DienThoai")),
				// DinhDangSQL.DeFomatSQL(rs.getString("Email")),
				// DinhDangSQL.DeFomatSQL(rs.getString("QuyenQuanTri"))),
				// DinhDangSQL.DeFomatSQL(rs.getString("NoiDungVi")),
				// DinhDangSQL.DeFomatSQL(rs.getString("NoiDungJa")),
	...
	/*
	 * Dùng cho trang client Lấy danh sách các bài viết phù hợp với nội dung tìm
	 * kiếm return ArrayList<BAIVIET> or null
	 */
	public ArrayList<BAIVIET> getFind(String txtFind, String vitri, String top) {
		...
		String sql = "select IdBaiViet,TenBaiVietVi,TenBaiVietJa,MoTaVi,MoTaJa,NoiDungVi,NoiDungJa,NgayDang,Lienket,LuotXem,HoTen from baiviet "
				+ "inner join taikhoan on baiviet.IdTaiKhoan=taikhoan.IdTaiKhoan "
				+ "where TrangThai=N'OK' and (TenBaiVietJa like N'%"
				+ txtFind
				+ "%' or TenBaiVietVi like N'%"
				+ txtFind
				+ "%'"
				+ " or MotaJa like N'%"
				+ txtFind
	...
	public ArrayList<BAIVIET> getFind(String kieu, String txtFind,
			String vitri, String top) {
		// TODO Auto-generated method stub
		String sql = "";
		if (kieu.equals("All")) {
			sql = "select IdBaiViet,TenBaiVietVi,TenBaiVietJa,MoTaVi,MoTaJa,NoiDungVi,NoiDungJa,NgayDang,Lienket,LuotXem,HoTen from baiviet "
					+ "inner join taikhoan on baiviet.IdTaiKhoan=taikhoan.IdTaiKhoan "
					+ "inner join danhmuc on baiviet.IdDanhMuc=danhmuc.IdDanhMuc "
					+ "where TrangThai=N'OK' and (TenDanhMucVi like N'%"
					+ txtFind
					+ "%' or TenDanhMucJa like N'%"
					+ txtFind
					+ "%'"
					+ " or TenBaiVietVi like N'%"
					+ txtFind
					+ "%' or TenBaiVietJa like N'%"
					+ txtFind
					+ "%'"
					+ " or MotaVi like N'%"
					+ txtFind
	...
	/*
	 * Dùng cho trang cộng tác viên Lấy danh sách bài viết tương ứng với tài
	 * khoản được phân công return ArrayList<BAIVIET> or null
	 */
	...
	public ArrayList<BAIVIET> getListPhanCong(String idTaiKhoan, int page) {
		...
		String sql = "select baiviet.IdBaiViet, TenBaiVietVi, TenBaiVietJa, MotaVi, MotaJa, NoiDungVi, NoiDungJa, GhiChu from baiviet "
				...
				+ "or lichsu.TrangThai = N'DaDich') and lichsu.IdTaiKhoan = N'"
				+ idTaiKhoan + "'";

		// Tạo menu phân trang Url, page, sql
		db.createMenu("DanhSachBaiDichServlet?view=all&", page, sql);
		rs = db.getResultSet(sql + " limit " + (page - 1) * db.getNBangGhi()
				+ "," + db.getNBangGhi());
		try {
			while (rs.next()) {
				BAIVIET bv = new BAIVIET();
	...
	/*
	 * Dùng cho trang cộng tác viên, admin Cập nhật trạng thái bài
	 * dịch(ChuyenDich, DangDich, DaDich, Ok, HuyDich, LoiDich, DangBai,
	 * MoiPost) return bool(kết quả cập nhật)
	 */
	public boolean CapNhatBaiViet(String id, String tieude, String mota,
		...
		if (ngonNgu.equals("ja")) {
			sql = "update baiviet set TenBaiVietVi=N'" + tieude
					+ "', MotaVi=N'" + mota + "', NoiDungVi=N'" + noidung
					+ "' where IdBaiViet=N'" + id + "'";
		} else {
			sql = "update baiviet set TenBaiVietJa=N'" + tieude
					+ "', MotaJa=N'" + mota + "', NoiDungJa=N'" + noidung
					+ "' where IdBaiViet=N'" + id + "'";
		}
	...
	public boolean CapNhatBaiViet(String id, String tinhtrang, String idTaiKhoan) {
		...
		tinhtrang = DinhDangSQL.FomatSQL(tinhtrang);
		idTaiKhoan = DinhDangSQL.FomatSQL(idTaiKhoan);
		String sql = "update lichsu set TrangThai=N'" + tinhtrang
				+ "' where IdBaiViet=N'" + id + "' and IdTaiKhoan=N'"
				+ idTaiKhoan + "'";
		return db.updateData(sql);
	}

	/*
	 * Dùng cho trang cộng tác viên Lấy danh sách bài dịch được phân công cho
	 * cộng tác viên x, với tùy chọn(Bài quá hạn, mới, đang dịch) return
	 * ArrayList<BAIVIET>
	 */
	...
	public ArrayList<BAIVIET> getListPhanCong(String idTaiKhoan, String view,
		...
		if (view.equals("qua-han")) {
			sql = "select baiviet.IdBaiViet, TenBaiVietVi, TenBaiVietJa, MotaVi, MotaJa, NoiDungVi, NoiDungJa, GhiChu from baiviet "
					+ "inner join lichsu on baiviet.IdBaiViet = lichsu.IdBaiViet "
					+ "where (lichsu.TrangThai = N'ChuyenDich' or lichsu.TrangThai = N'DangDich' or lichsu.TrangThai = N'LoiDich' "
					+ "or lichsu.TrangThai = N'DaDich') and CURDATE()-ThoiGian>3  and lichsu.IdTaiKhoan = N'"
					+ idTaiKhoan + "'";
	...
	/*
	 * Dùng cho trang cộng tác viên, admin Cập nhật bình luận bài viết qua lại
	 * giữa ctv và admin return bool(true(Thành công)/false(Thất bại))
	 */
	public boolean setBinhLuan(String id, String bluan) {
		// TODO Auto-generated method stub
		return db.updateData("update baiviet set GhiChu=CONCAT(GhiChu, N'"
				+ DinhDangSQL.FomatSQL(bluan) + "') where IdBaiViet=N'" + id
				+ "'");
	}

	/*
	 * Dùng cho trang cộng tác viên Đếm số lượng bài viết có trong danh sách
	 * đươc chọn(Tất cả, Mới chuyển, Dịch Bài, Quá hạn) return String =
	 * count(list)
	 */
	public String getCount(String chon, String taikhoan) {
		...
		String sql = "";
		if (chon.equals("all")) {
			sql = "select count(*) as dem from lichsu where (TrangThai = N'ChuyenDich' or TrangThai = N'DangDich' or TrangThai = N'LoiDich' or TrangThai = N'DaDich') and IdTaiKhoan = N'"
					+ taikhoan + "'";
		} else if (chon.equals("moi")) {
			sql = "select count(*) as dem from lichsu where (TrangThai = N'ChuyenDich' or TrangThai = N'LoiDich') and IdTaiKhoan = N'"
					+ taikhoan + "'";
		} else if (chon.equals("dich")) {
			sql = "select count(*) as dem from lichsu where (TrangThai = N'DangDich' or TrangThai = N'DaDich') and IdTaiKhoan = N'"
					+ taikhoan + "'";
		} else {
			sql = "select count(*) as dem from lichsu where (TrangThai = N'ChuyenDich' or TrangThai = N'DangDich' or TrangThai = N'LoiDich' or TrangThai = N'DaDich') and CURDATE()-ThoiGian>3 and IdTaiKhoan = N'"
					+ taikhoan + "'";
		}
		ResultSet rs = db.getResultSet(sql);
		try {
	...
	/*
	 * Dùng cho trang cộng tác viên Lấy thông tin bài viết có Id và được dịch
	 * bởi ctv có id = idTaiKhoan return String =
	 * "Trạng thái bài dịch hiện tại, Ngày gửi bài đó tới cho cộng tác viên dịch"
	 */
	public String getInfo(String id, String idTaiKhoan) {
		// TODO Auto-generated method stub
		String sql = "select TrangThai, ThoiGian  from lichsu where IdBaiViet=N'"
				+ id + "' and IdTaiKhoan=N'" + idTaiKhoan + "'";
		ResultSet rs = db.getResultSet(sql);
		try {
			if (rs.next()) {
	...
	/*
	 * Dùng cho trang client Lấy danh sách bài viết của 1 user (Đã đăng, Đang
	 * duyệt, Bị hủy) return ArrayList<BAIVIET>
	 */
	public ArrayList<BAIVIET> getListBaiViet(String id, int page) {
		// TODO Auto-generated method stub
		String sql = "select IdBaiViet, TenBaiVietVi, TenBaiVietJa, LuotXem, NgayDang, TrangThai, Lienket from baiviet where IdTaiKhoan=N'"
				+ id + "'";
		SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
		db.createMenu("TrangCaNhanServlet?", page, sql);
		ResultSet rs = db.getResultSet(sql + " limit " + (page - 1)
				* db.getNBangGhi() + "," + db.getNBangGhi());
		ArrayList<BAIVIET> list = new ArrayList<BAIVIET>();
		try {
			while (rs.next()) {
				BAIVIET bv = new BAIVIET();
				...
				bv.setLuotXem(rs.getInt("LuotXem"));
				bv.setNgayDang(sdf.format(rs.getDate("NgayDang")));
				String trangthai = DinhDangSQL.DeFomatSQL(rs
						.getString("TrangThai"));
				if (trangthai.equals("OK"))
					bv.setTrangThai("Đã đăng<br>既設");
				else if (trangthai.equals("MoiDang")
						|| trangthai.equals("DangDich")
						|| trangthai.equals("KhongDich"))
	...
	public boolean CapNhatBaiViet(String id, String tieuDe, String moTa,
		...
		if (ngonngu.equals("vi")) {
			sql = "update baiviet set TenBaiVietVi=N'" + tieuDe
					+ "', MotaVi=N'" + moTa + "'," + " IdDanhMuc=N'" + theLoai
					+ "', IdTaiKhoan=N'" + taiKhoan + "'," + " NoiDungVi=N'"
					+ noiDung + "', TrangThai=N'" + tinhTrang + "',"
					+ " Lienket=N'" + hinh + "' where IdBaiViet=N'" + id + "'";
		} else {
			sql = "update baiviet set TenBaiVietJa=N'" + tieuDe
					+ "', MotaJa=N'" + moTa + "'," + " IdDanhMuc=N'" + theLoai
					+ "', IdTaiKhoan=N'" + taiKhoan + "'," + " NoiDungJa=N'"
					+ noiDung + "', TrangThai=N'" + tinhTrang + "',"
					+ " Lienket=N'" + hinh + "' where IdBaiViet=N'" + id + "'";
		}
		return db.updateData(sql);
	...
	public boolean CapNhatBaiViet(String id, String tieuDeVi, String tieuDeJa,
		...
		taiKhoan = DinhDangSQL.FomatSQL(taiKhoan);
		// TODO Auto-generated method stub
		String sql = "update baiviet set TenBaiVietVi=N'" + tieuDeVi
				+ "', MotaVi=N'" + moTaVi + "'," + " MotaJa=N'" + moTaJa
				+ "', TenBaiVietJa=N'" + tieuDeJa + "'," + " IdDanhMuc=N'"
				+ theLoai + "', IdTaiKhoan=N'" + taiKhoan + "',"
				+ " NoiDungVi=N'" + noiDungVi + "', NoiDungJa=N'" + noiDungJa
				+ "'," + " Lienket=N'" + hinh + "', TrangThai=N'" + tinhTrang
				+ "' where IdBaiViet=N'" + id + "'";
		return db.updateData(sql);
	}
	...
	public boolean XoaBaiViet(String id) {
		// TODO Auto-generated method stub
		String sql = "delete from baiviet where IdBaiViet=N'"
				+ DinhDangSQL.FomatSQL(id) + "'";
		return db.updateData(sql);
	}
}
