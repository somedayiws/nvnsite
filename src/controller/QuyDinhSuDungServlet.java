...
@WebServlet("/Quy-dinh")
public class QuyDinhSuDungServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public QuyDinhSuDungServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("quydinh", tainguyen.getValue("NoiQuy"));
		...
		request.getRequestDispatcher("QuyDinhSuDung.jsp").forward(request, response);
	}
