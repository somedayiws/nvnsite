	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(user != null){
			...
			if(!email.equals(user.getEmail())){
				...
				noidung += "\nĐã nhận được phản hồi từ các thành viên.\nVui lòng truy cập http://jpvnnetl.jvmhost.net/Xem-bai-viet?id=" + id+" trên để biết thêm chi tiết.";
				...
				noidungtb += "<br>Bạn vừa nhận được phản hồi từ các thành viên.<br>Vui lòng truy cập <a href='http://jpvnnetl.jvmhost.net/Xem-bai-viet?id=" + id+"'>http://jpvnnetl.jvmhost.net/Xem-bai-viet?id=" + id+"</a> để biết thêm chi tiết.";
